...
MODEL_PARAM = {
    ...
    "pred_len": OUTPUT_LEN,
    "num_nodes": 358,
    "init_path_daily": 'datasets/PEMS03/daily_init.npy',
    "init_path_weekly": 'datasets/PEMS03/weekly_init.npy',
...
CFG = EasyDict()
# General settings
CFG.DESCRIPTION = 'HyperD-PEMS03-Config'
...
CFG.ENV.SEED = 1 #random.randint(0, 2**32 - 1) # Random seed. Default: None
